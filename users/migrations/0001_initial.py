    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('test_date', models.DateTimeField(blank=True, null=True, verbose_name='Дата последнего прохождения теста')),
                ('next_test_date', models.DateTimeField(blank=True, null=True, verbose_name='Тест недоступен до')),
